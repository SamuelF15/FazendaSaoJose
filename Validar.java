...
public class Validar {
    ...
    public static boolean validarPagamento(String salario){
        String ValidarPag = "^(1\\d{2}|[1-9]\\d{3}|10000)$";
        Pattern CompiladorPag = Pattern.compile(ValidarPag);
        Matcher VerificadorPag = CompiladorPag.matcher(salario);
        return VerificadorPag.matches();
    }
}